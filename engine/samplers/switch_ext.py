...
class SwitchSamplerExtension(Sampler):

    # note: always shuffle, batch_size is the number of samples "per worker"
    def __init__(self, dataset, batch_size, seed=None, max_num_samples=None):
        ...
        self.max_size = max_num_samples or sum(self.sizes)
    ...
    def _infinite_indices(self):
        ...
        while True:
            indices = [
                (s + torch.randperm(n, generator=g)).tolist()[:self.max_size]
