...
def get_bbox_from_mask(mask, size_divisor=1):
    """
    ...
    for row, col in zip(rows, cols):
        ...
        if size_divisor != 1:
            left = left // size_divisor * size_divisor
            up = up // size_divisor * size_divisor
            right = (right + size_divisor - 1) // size_divisor * size_divisor
            bottom = (bottom + size_divisor - 1) // size_divisor * size_divisor
